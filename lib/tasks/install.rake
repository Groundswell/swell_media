...
namespace :swell_media do
	task :install do
		...
		files = { 	'.env' => :root, 
					...
					'user.rb' => 'app/models',
					'static_controller.rb' => 'app/controllers',
					'home.html.haml' => 'app/views/swell_media/static',
					'application.html.haml' => 'app/views/layouts',
					'sessions.html.haml' => 'app/views/layouts',
					'articles.html.haml' => 'app/views/layouts/swell_media',
					'pages.html.haml' => 'app/views/layouts/swell_media',
					'homepage.html.haml' => 'app/views/layouts/swell_media',
